        ...
        {{-- <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                    ...
                    @include('layout/admin/dashboard/nav-bar')
            </div>
        </nav> --}}
            ...
            <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
              ...
              <div x-data="{ isActive: false, open: false }">
                ...
                >
                  ...
                  <span class="ml-2 text-sm"> Teacher </span>
                ...
                <x-modal3 :actionType="'Add Student'">
                    <x-slot name="button">
                        addteacher
                    </x-slot>
              ...
              {{-- <div x-data="{ isActive: false, open: false }">
                ...
                <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                  ...
                  <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                    ...
                    <x-modal :actionType="'Add Student'">
                        <x-slot name="button">
                            <a  href="#login/signup" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700" style="cursor: pointer;">Add Students</a>
                        </x-slot>
                        <x-slot name="content">
                            @livewire('modal.admin-modal')
                        </x-slot>
                    </x-modal>
                ...
                <x-modal1>
                  <x-slot name="modal_class">
                    ...
                    <x-slot name="content">
                        @livewire('modal.delete-student')
                    </x-slot>
                </x-modal1>
                  <a
                    href="{{route('viewstudent')}}"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                  >
                    View Student
