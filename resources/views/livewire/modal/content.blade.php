<div>
    @if ($accType)
        @livewire('auth.login',['accType'=>$accType])
    @else
        ...
        <div class="relative inline-flex">
            ...
            <select wire:model="accType" class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
