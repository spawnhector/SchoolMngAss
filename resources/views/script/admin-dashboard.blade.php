        ...
        ">
                ...
                <div class="mt-6">
                    ...
                    ">
                        ...
                        <button wire:click="addStudent()" type="submit" class="btn btn-primary btn-lg" id="load2" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Adding Student">Add Student</button>
                    <div>
                    </div>
                </div>
                </div>
